...
#Work-grid
  ...
  .work-item
    background: linear-gradient(235.55deg, rgba($magenta, 0.5) 0%, rgba($mint, 0.5) 93.78%), url(http://fillmurray.com/200/200)
    background-size: cover
    color: white
    ...
    &:hover
      ...
      //box-shadow: 0px 0px 25px rgba(#000, 0.8)
    &:nth-child(1)
      grid-row: 2/ span 1
