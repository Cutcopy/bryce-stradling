...
<path d="M282.263 272.053L82.7192 388.124L82.7192 155.981L282.263 272.053Z" fill="#C4C4C4"/>
<path d="M192.059 272.053L-7.48529 388.124L-7.48529 155.981L192.059 272.053Z" fill="#604949"/>
...
<path d="M52.6514 272.053L252.195 388.124L252.195 155.981L52.6514 272.053Z" fill="#C4C4C4"/>
...
<path d="M96.5696 681.19L601.344 387.084L601.344 975.296L96.5696 681.19Z" fill="#604949"/>
<g style="mix-blend-mode:overlay">
<rect width="3830.75" height="679.209" fill="black" fill-opacity="0" transform="translate(-452 1020.79) scale(1 -1)"/>
<path d="M449.217 681.19L-55.5574 387.084L-55.5574 975.296L449.217 681.19Z" fill="#C4C4C4"/>
...
<path d="M93.1165 562.782L-6.72091 504.746L-6.72091 620.818L93.1165 562.782Z" fill="#604949"/>
...
<path d="M23.3672 562.782L123.205 504.746L123.205 620.818L23.3672 562.782Z" fill="#C4C4C4"/>
<path d="M68.4995 562.782L168.337 504.746V620.818L68.4995 562.782Z" fill="#604949"/>
</g>
<rect style="mix-blend-mode:overlay" y="73.5301" width="1440" height="906.955" :fill="colors.forground"/>
<ellipse cx="225.5" cy="763.32" rx="315.5" ry="317.938" :fill="colors.background" style="mix-blend-mode:hard-light"/>
<ellipse cx="627" cy="301.277" rx="120" ry="120.927" :fill="colors.background" style="mix-blend-mode:hard-light"/>
<ellipse cx="879" cy="891.805" rx="50" ry="50.3864" :fill="colors.background" style="mix-blend-mode:hard-light"/>
<ellipse cx="1024" cy="713.437" rx="50" ry="50.3864" :fill="colors.background" style="mix-blend-mode:hard-light"/>
<ellipse cx="1216.5" cy="300.773" rx="225.5" ry="227.243" :fill="colors.background" style="mix-blend-mode:hard-light"/>
<ellipse cx="-9.5" cy="101.243" rx="225.5" ry="227.243" :fill="colors.background" style="mix-blend-mode:hard-light"/>
<ellipse cx="1336.5" cy="970.912" rx="205.5" ry="207.088" :fill="colors.background" style="mix-blend-mode:hard-light"/>
</svg>
</div>
</template>
<script>
